...
public class UserOwnedRepositoriesFetcher {
	...
	public static void main(String[] args) {
		...
		userRepoExtractor.setType(RepositoryType.Owned.name());
		...
		for (User user : users) {
			...
			while (true) {
				try {
					...
					String userRepoJsonString = pullObject.fetchJSONString(user.getReposUrl(),
